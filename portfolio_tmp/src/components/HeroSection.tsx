  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center px-6 pt-24">
        ...
        <h1 className="font-serif text-5xl md:text-7xl lg:text-8xl text-foreground leading-tight mb-6 animate-fade-up" style={{ animationDelay: "0.1s" }}>
          Crafting Digital
          <br />
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-xl mx-auto mb-10 animate-fade-up" style={{ animationDelay: "0.2s" }}>
          I build thoughtful, performant web applications with clean code and a keen eye for design.
        </p>
        <div className="flex gap-4 justify-center animate-fade-up" style={{ animationDelay: "0.3s" }}>
          <a
            href="#projects"
